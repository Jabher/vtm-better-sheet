import {H4} from "../globals/Headings.tsx";
...
export const SheetCombat = () => <div className="sheet-colrow sheet-tab-content sheet-tabCombat">
                    ...
                    () => <div className="sheet-tabCombat--item">
                        <div>
                            ...
                            <select name="attr_MeleeWeaponLethality">
                                <option value={0} data-i18n="bashing-u">Bashing</option>
                                <option value={2} selected data-i18n="lethal-u">Lethal</option>
                                <option value={3} data-i18n="aggravated-u">Aggravated</option>
                            </select>
                            <Input i18n="conceal-u" name="attr_MeleeWeaponConceal"/>
                        </div>
                        <ResizingTextarea labelName="Notes" name="attr_MeleeWeaponDesc"/>
                    </div>
                }
            </RepeatingSection>
        </SectionBody>
            ...
            <RepeatingSection name="repeating_MeleeWeapons">
                {
                    () => <div className="sheet-tabCombat--item">
                        ...
                        <ResizingTextarea labelName="Notes" name="attr_RangedWeaponDesc"/>
                    </div>
                }
            </RepeatingSection>
        </SectionBody>
    ...
    <Section>
        ...
        <SectionBody>
            <RepeatingSection name="RangedAttacks">{() => <div className="sheet-tabCombat--item">
                <div>
                    <H4 i18n="onq-u"/>
                    ...
                    <select name="attr_ArmorType">
                        <option value={1} selected data-i18n="armor-u">Armor</option>
                        <option value={2} data-i18n="shield-u">Shield</option>
                        <option value={3} data-i18n="bodymod-u">Body Mod.</option>
                        <option value={3} data-i18n="other-u">Other</option>
                    </select>
                    ...
                    <select name="attr_ArmorAgainstAggravated"> {/*todo*/}
                        <option value={0} selected data-i18n="no-u">No</option>
