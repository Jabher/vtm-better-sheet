...
import {H3, H4} from "../components/globals/Headings.tsx";
        ...
        <div className="sheet-col" style={{ width: "100%" }}>
          ...
          <div className="sheet-col">
            <div className="sheet-col">
              <div className="sheet-col">
                ...
                <input type="number" name="attr_PermWillpowerDiff" className="sheet-inputname" defaultValue={6} />
                <RollButton
                  className="sheet-custom-button sheet-vampire-button"
                  name="PermWillpowerRoll"
              ...
              <div className="sheet-col" style={{ width: "15%" }}>
                ...
                <input type="number" name="attr_TempWillpowerDiff" className="sheet-inputname" defaultValue={6} />
                <RollButton
                  className="sheet-custom-button sheet-vampire-button"
                  name="TempWillpowerRoll"
              ...
              <div className="sheet-col" style={{ width: "20%" }}>
                <select className="sheet-center-select" name="attr_virtueConsName">
                  <option value="Conscience">Conscience</option>
                  <option value="Conviction">Conviction</option>
                </select>
                <input type="number" name="attr_ConscConvDiff" className="sheet-inputname" defaultValue={6} />
                <RollButton
                  name="ConscConvRoll"
              ...
              <div className="sheet-col" style={{ width: "20%" }}>
                <select className="sheet-center-select" name="attr_virtueSelfName">
                  <option value="Self-Control">Self-Control</option>
                  <option value="Instinct">Instinct</option>
                </select>
                <input type="number" name="attr_SelfCInstDiff" className="sheet-inputname" defaultValue={6} />
                <RollButton
                  name="SelfCInstRoll"
              ...
              <div className="sheet-col" style={{ width: "20%" }}>
                <H4 i18n="courage-u" />
                <input type="number" name="attr_CourageDiff" className="sheet-inputname" defaultValue={6} />
                <RollButton
                  name="CourageRoll"
            ...
            <div className="sheet-col" style={{ width: 150, textAlign: "center" }}>
              <h4 style={{ textAlign: "center", width: "100%" }}>Wound Penalties</h4>
              <select name="attr_Health" className="sheet-center-select" defaultValue={0}>
                <option value={0}>Healthy/Bruised (0)</option>
            ...
            <div className="sheet-col" style={{ width: 140, textAlign: "center", marginLeft: 25 }}>
              <h4 style={{ textAlign: "center", width: "100%" }}>Temp. Willpower</h4>
              <select
            ...
            <div className="sheet-col" style={{ width: 130, textAlign: "center", marginLeft: 25 }}>
              <h4 style={{ textAlign: "center", width: "100%" }}>Blood Points</h4>
              <select
                className="sheet-center-dots"
                name="attr_BloodPool"
                style={{ width: 130, textAlign: "center" }}
                  ...
                  <tbody>
                    <tr>
                      <td style={{ width: "15%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Name</h4>
                      </td>
                      <td style={{ width: "15%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Attribute</h4>
                      </td>
                      <td style={{ width: "15%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Abillity</h4>
                      </td>
                      <td style={{ width: "15%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Discipline</h4>
                      </td>
                      <td style={{ width: "5%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Modifiers</h4>
                      </td>
                      ...
                      <td style={{ width: "10%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Difficulty</h4>
                      </td>
                      <td style={{ width: "20%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Rolls</h4>
                      </td>
                    </tr>
                  </tbody>
                </table>
                <fieldset className="repeating_mainDice" name="attr_maindicesection">
                  <table style={{ width: "100%" }}>
                    <tbody>
                      <tr>
                        <td style={{ width: "15%" }}>
                          <input type="text" name="attr_mainrollTitle" className="sheet-inputname" />
                        </td>
                        <td style={{ width: "15%" }}>
                          <select name="attr_mainattributeRoll" className="sheet-center-select">
                        ...
                        <td style={{ width: "15%" }}>
                          <select name="attr_mainabilityRoll" className="sheet-center-select">
                        ...
                        <td style={{ width: "15%" }}>
                          <select name="attr_maindisciplineRoll" className="sheet-center-select">
                            <optgroup label="Disciplines">
                              ...
                              <option value="@{Discipline5}">Discipline 5</option>
                              <option value="@{Discipline6}">Discipline 6</option>
                              <option value="@{Discipline7}">Discipline 7</option>
                            </optgroup>
                            <optgroup label="Other">
                              <option value={0}>None</option>
                            </optgroup>
                        ...
                        <td style={{ width: "5%", textAlign: "center" }}>
                          <input type="number" defaultValue={0} className="sheet-inputname" name="attr_mainmodNumber" />
                        </td>
                        <td style={{ width: "10%", textAlign: "center" }}>
                          <select name="attr_useHealth" className="sheet-center-select">
                            <option value="@{Health}">Yes</option>
                            <option value={0}>No</option>
                          </select>
                        </td>
                        <td style={{ width: "10%", textAlign: "center" }}>
                          <input type="number" name="attr_mainrollDiff" className="sheet-inputname" defaultValue={6} />
                        </td>
                        <td style={{ width: "20%", textAlign: "center" }}>
                          <RollButton
                            className="sheet-custom-button sheet-vampire-button"
              ...
              <SectionBody className="sheet-colrow sheet-table">
                <table style={{ width: "100%" }}>
                  <tbody>
                    <tr>
                      <td style={{ width: "15%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Attribute 1</h4>
                      </td>
                      <td style={{ width: "15%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Attribute 2</h4>
                      </td>
                      <td style={{ width: "15%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Discipline</h4>
                      </td>
                      ...
                      <td style={{ width: "10%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Add to Tracker?</h4>
                      </td>
                      <td style={{ width: "10%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Rolls</h4>
                      </td>
                ...
                <table style={{ width: "100%" }}>
                  <tbody>
                    <tr>
                      <td style={{ width: "15%", textAlign: "center" }}>
                        <select name="attr_attribute1Roll" className="sheet-center-select">
                          <optgroup label="Physical">
                            <option value="@{Strength}+@{StrengthBoost}">Strength</option>
                            <option value="@{Dexterity}+@{DexterityBoost}">Dexterity</option>
                            <option value="@{Stamina}+@{StaminaBoost}">Stamina</option>
                      ...
                      <td style={{ width: "15%", textAlign: "center" }}>
                        <select name="attr_attribute2Roll" className="sheet-center-select">
                          <optgroup label="Physical">
                            <option value="@{Strength}+@{StrengthBoost}">Strength</option>
                            <option value="@{Dexterity}+@{DexterityBoost}">Dexterity</option>
                            <option value="@{Stamina}+@{StaminaBoost}">Stamina</option>
                      ...
                      <td style={{ width: "15%", textAlign: "center" }}>
                        <select name="attr_initiativedisciplineRoll" className="sheet-center-select">
                          <optgroup label="Disciplines">
                            <option value="@{Discipline1}">Discipline 1</option>
                            <option value="@{Discipline2}">Discipline 2</option>
                            <option value="@{Discipline3}">Discipline 3</option>
                      ...
                      <td style={{ width: "5%", textAlign: "center" }}>
                        <input type="number" defaultValue={0} className="sheet-inputname" name="attr_modNumber" />
                      </td>
                      <td style={{ width: "10%", textAlign: "center" }}>
                        <select name="attr_initiativeuseHealth" className="sheet-center-select">
                          <option value="@{Health}">Yes</option>
                          <option value={0}>No</option>
                        </select>
                      </td>
                      <td style={{ width: "5%", textAlign: "center" }}>
                        <input type="number" name="attr_initrollDiff" className="sheet-inputname" defaultValue={6} />
                      </td>
                      <td style={{ width: "10%", textAlign: "center" }}>
                        <select name="attr_initiativeaddTracker" className="sheet-center-select">
            ...
            <Section>
              ...
              <SectionBody>
                ...
                <fieldset className="repeating_combatDice" name="attr_combatdicesection">
                  <table style={{ width: "100%" }}>
                    <tbody>
                      <tr>
                        <td style={{ width: "15%", textAlign: "center" }}>
                          <input type="text" name="attr_combatrollTitle" className="sheet-inputname" />
                        </td>
                        <td style={{ width: "15%", textAlign: "center" }}>
                          <select name="attr_combatattributeRoll" className="sheet-center-select">
                            <optgroup label="Physical">
                              <option value="@{Strength}+@{StrengthBoost}">Strength</option>
                              <option value="@{Dexterity}+@{DexterityBoost}">Dexterity</option>
                              <option value="@{Stamina}+@{StaminaBoost}">Stamina</option>
                        ...
                        <td style={{ width: "15%", textAlign: "center" }}>
                          <select name="attr_combatabilityRoll" className="sheet-center-select">
                            <optgroup label="Talents">
                              <option value="@{Alertness}">Alertness</option>
                              <option value="@{Athletics}">Athletics</option>
                              <option value="@{Awareness}">Awareness</option>
                        ...
                        <td style={{ width: "15%", textAlign: "center" }}>
                          <select name="attr_combatdisciplineRoll" className="sheet-center-select">
                            <optgroup label="Disciplines">
                              <option value="@{Discipline1}">Discipline 1</option>
                              <option value="@{Discipline2}">Discipline 2</option>
                              <option value="@{Discipline3}">Discipline 3</option>
                        ...
                        <td style={{ width: "10%", textAlign: "center" }}>
                          <select name="attr_combatuseHealth" className="sheet-center-select">
                            <option value="@{Health}">Yes</option>
                            <option value={0}>No</option>
                          </select>
                        </td>
                        <td style={{ width: "10%", textAlign: "center" }}>
                          <input type="number" name="attr_combatDiff" className="sheet-inputname" defaultValue={6} />
                        </td>
                        <td style={{ width: "20%", textAlign: "center" }}>
                          <RollButton
                            className="sheet-custom-button sheet-vampire-button"
            ...
            <Section>
              ...
              <SectionBody>
                <table style={{ width: "100%" }}>
                  <tbody>
                    <tr>
                      ...
                      <td style={{ width: "10%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Dice</h4>
                      </td>
                      <td style={{ width: "10%", textAlign: "center" }}>
                        <h4 style={{ width: "100%", textAlign: "center" }}>Difficulty</h4>
                      </td>
                ...
                <fieldset className="repeating_CustomDice" name="attr_customdicesection">
                  <table style={{ width: "100%" }}>
                    <tbody>
                      <tr>
                        <td style={{ width: "35%" }}>
                        ...
                        <td style={{ width: "10%", textAlign: "center" }}>
                          <select name="attr_customuseHealth" className="sheet-center-select">
                            <option value="@{Health}">Yes</option>
                            <option value={0}>No</option>
                          </select>
                        </td>
                ...
                <input type="number" name="attr_StrengthScript" style={{ visibility: "collapse" }} />
                <input type="number" name="attr_DexterityScript" style={{ visibility: "collapse" }} />
                <input type="number" name="attr_StaminaScript" style={{ visibility: "collapse" }} />
                <input type="number" name="attr_CharismaScript" style={{ visibility: "collapse" }} />
                <input type="number" name="attr_ManipulationScript" style={{ visibility: "collapse" }} />
                <input type="number" name="attr_AppearanceScript" style={{ visibility: "collapse" }} />
                <input type="number" name="attr_PerceptionScript" style={{ visibility: "collapse" }} />
                <input type="number" name="attr_IntelligenceScript" style={{ visibility: "collapse" }} />
                <input type="number" name="attr_WitsScript" style={{ visibility: "collapse" }} />
              </SectionBody>
            </Section>
          </div>
          ...
          <template className="sheet-rolltemplate-wod">
            <div className="regularContainer">
              ...
              <div>
                <div className="regularResult">{`{{result}} Successes`}</div>
              </div>
            </div>
          </template>
          <template className="sheet-rolltemplate-wodinitiative">
            <div className="initiativeContainer">
              ...
              <div>
                <div className="initiativeResult">{`{{result}} Initiative`}</div>
              </div>
            </div>
          </template>
