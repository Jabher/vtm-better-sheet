...
export const SheetMerits = () => <Section>
    <SectionHead>Merits</SectionHead>{/*todo intl*/}
    <SectionBody>
        <div>
            <RepeatingSection name="Merits" initialCount={1}>
                {
                    () => <>
                        ...
                        <ResizingTextarea labelName="Description" name="attr_meritdesc"/>
                    </>
                }
            </RepeatingSection>
        </div>
            ...
            <RepeatingSection name="Flaws" initialCount={1}>
                {
                    () => <>
                        ...
                        <ResizingTextarea labelName="Description" name="attr_flawdesc"/>
                    </>
                }
            </RepeatingSection>
        </div>
