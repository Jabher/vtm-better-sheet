...
export const SheetSorcery = () => <div className="sheet-tab-content sheet-tabSorcery">
    <Section>
        ...
        <SectionBody style={{columns: 3}}>
            {
                range(1, 13).map((i) => <div style={{display: 'flex'}}>
                ...
                {() => <div style={{display: 'flex', flexWrap: 'wrap'}}>
                    ...
                    <select name="attr_ritualAW" className="sheet-center-select">
                        ...
                        <optgroup label="Willpower">
                            <option value="@{Willpower}" selected>Perm. Willpower</option>
                    ...
                    <select name="attr_ritualuseHealth" className="sheet-center-select"> {/*todo checkbox*/}
                        <option value="@{Health}" selected>Yes</option>
                    ...
                    <ResizingTextarea labelName="Description" name="attr_ritualdesc"/>
                </div>
                }
            </RepeatingSection>
        </SectionBody>
